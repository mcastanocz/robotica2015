...
/** \mainpage RoboComp::primercomponente
 *
 * \section intro_sec Introduction
 *
 * The primercomponente component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/primercomponente --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
class primercomponente : public RoboComp::Application
{
public:
	primercomponente (QString prfx) { prefix = prfx.toStdString(); }
private:
	void initialize();
	std::string prefix;
	MapPrx mprx;
...
void ::primercomponente::initialize()
{
...
int ::primercomponente::run(int argc, char* argv[])
{
#ifdef USE_QTGUI
